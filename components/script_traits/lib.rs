...
/// focus state synchronization. Example:
///
/// ```text
...
/// the document is focused, but from the constellation's point of view, the
...
/// script thread. This can be resolved by associating a sequence number to
/// each message.
///
/// ```text
/// script                            constellation
